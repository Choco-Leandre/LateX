...
\fancyhead[C]{{\fontfamily{phv}\selectfont $\cdots$ Colle n° - Nom $\cdots$}}
...
cf: fichier \pg{truc.pdf} prévu à cet effet
\section*{Récitations \textcolor{black!50}{\dashfill}}
\textbf{- a. \hfill \emph{\textcolor{mygrayblue}{(Chap. )}}}\\
